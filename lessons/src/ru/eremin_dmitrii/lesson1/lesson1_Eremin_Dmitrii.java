...
public class lesson1_Eremin_Dmitrii {
    ...
    public static void main (String[] args)
    {
        ...
        System.out.println ("Задание 3: a * (b + (c / d)) = " + isCalculate(10,5,10,3));

        System.out.println(isLessOrMore(5.26,6.69));
        System.out.println(isLessOrMore(5.26,16.69));
    ...
    */
    ...
    {
        System.out.println("Задание 4: ((a + b > 10) && (a + b <= 20)): " + "a = " + a + ",b = " + b);
    ...
    static void isPlusOrMinus (int a)
    {
        if (a >= 0)
        {
