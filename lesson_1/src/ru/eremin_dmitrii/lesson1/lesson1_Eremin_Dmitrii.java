...
public class lesson1_Eremin_Dmitrii {
    ...
    public static void main (String[] args)
    {
        ...
        question2((byte) -128, (short) 32767, -2147483648,9223372036854775807L, 2.15f, 2.38, '*', true);

        System.out.println ("Задание 3: a * (b + (c / d)) = " + question3(10,5,10,5));

        System.out.println("Задание 4: ((a + b > 10) && (a + b <= 20)): " + question4((byte) 5, (byte) 6));
        ...
        System.out.println(question6(-5));
        System.out.println(question6(5));
        System.out.println(question6(0));
    ...
    static void question2(byte b, short s, int i, long l, float f, double d, char c, boolean bool)
    {
    ...
    static int question3 (int a, int b, int c, int d)
    {
        return a * (b + (c / d));
    }
    ...
    */
    ...
    static boolean question4 (byte a, byte b)
    {
        if ((a + b > 10) && (a + b <= 20))
        {
        return true;
    ...
    static boolean question6 (int a)
    {
    ...
    static void question7 (String name) {
    ...
    */
    ...
    static boolean question8 (int year)
    {
        boolean x = true;
